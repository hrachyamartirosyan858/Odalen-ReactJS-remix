...
export default function TopBar({ bgColor, iconsColor }) {
  return (
    <div>
      ...
      >
        <div className={`${iconsColor}`} >Հետևեք մեզ</div>
      ...
      <div className={`${bgColor} flex flex-row items-center justify-center space-x-4`}>
        <div style={{ color: `${iconsColor}` }}>Ամրագրում 033 27-07-77, 010 37-07-77</div>
